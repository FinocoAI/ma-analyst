...
DEFAULT_BROWSER_HEADERS = {
    ...
    # Omit Accept-Encoding: httpx adds gzip/deflate (and br only if brotli is installed).
    # Advertising br without a decoder yields undecoded bodies from servers that prefer Brotli.
